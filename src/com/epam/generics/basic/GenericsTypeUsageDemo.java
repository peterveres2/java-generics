...
public class GenericsTypeUsageDemo {
	...
	public static void main(String[] args) {
		...
		// wrong type for key
		// -> compile error: numbers.put(3, 3);
		// wrong type for value
		// -> compile error: numbers.put("pi", "3.14");
		// wrong type for returned value
		// -> compile error: LocalDate d = (LocalDate) numbers.get("pi");
		
		
		// This does not compile!
		// returns Number, not Double; solution: use a cast
		// -> compile error: Double doublePi = numbers.get("pi");
